...
const mainNavbarRoutes = new Set([
  "/404",
  "/address",
  "/billing",
  "/blog",
...
const calculatorNavbarRoutes = new Set([
  "/kalkulator-berat-kertas",
  "/kalkulator-percetakan",
  ...
  "/store-kertas",
  "/store",
  "/support-ticket-detail-kalkulator",
  "/support-ticket-kalkulator",
]);
